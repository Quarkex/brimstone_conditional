  ...
  describe "Conditional" do
    test "to_string behaviour serializes correctly a conditional" do
      assert String.Chars.to_string(%Conditional{and: [true, true, true]}) ==
               "module:Elixir.BrimstoneConditional;version:0.1.0;"
    end
